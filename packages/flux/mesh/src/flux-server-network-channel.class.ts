import { ConnectedClient } from './_classes/connected-client.class';
...
export class FluxNetworkChannelServer {
     ...
     * @param message
     */
    public publish(clientId: string, message: string): void {
    ...
    public leave(connectedClient: ConnectedClient): void {
    ...
    public join(connectedClient: ConnectedClient): void {
